...
/** Markdown 富文本渲染：无序/有序/多级列表 + 表格 + 代码块 */
export const markdownRichCase: TestCase = {
  id: "ui-markdown-rich",
  name: "富文本渲染（有序列表+表格+代码块）",
  group: "UI 渲染",
  description:
    "LLM 返回包含无序列表、有序列表、多级嵌套列表、Markdown 表格、多个代码块的完整回复，验证渲染效果。",
  expectedBehavior:
    "消息气泡正确渲染无序列表、有序列表、多级缩进列表、表格、代码块；嵌套层级视觉区分清晰，表格有边框对齐。",
  initialTurns: [],
