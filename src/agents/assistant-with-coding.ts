...
import GenerateUiWithModules from '../tools/generate-ui-with-modules'
...
export const requestAssistantWithCodingAgent = (params: any) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    workspace.openComponentDoc('mybricks.normal-pc.antd5.custom-container')
    ...
    context.rxai.requestAI({
      ...
      tools: [
        ...
        GenerateUiWithModules({
          ...
          appendPrompt: agentConfig?.attentions,
          ...agentConfig?.getToolParams(GenerateUiWithModules.toolName),
      ...
      planList: [GenerateUiWithModules.toolName],
